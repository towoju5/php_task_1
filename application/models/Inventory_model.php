...
class Inventory_model extends Manaknight_Model
{
    ...
    // frontend functions
    public function get_all_active_items_list_fe($search_term = '', $school_id = '', $professor_id = '', $textbook_id = '', $class_id = '', $isbn = '', $order_by = '', $direction = '', $offset = '', $limit = '', $year = '')
    {
        ...
        if ($order_by && $direction) {
            if (in_array($order_by, ['school_id', 'isbn', 'class_id', 'professor_id', 'textbook_id', 'year', 'word_count', 'note_type', 'year'])) {
