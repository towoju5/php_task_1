...
class Home_controller extends Manaknight_controller
{
    ...
    public function buy($offset = 0)
    {
        ...
        $order_by_year = $this->input->get('year', true);
        ...
        $rows_data = $this->inventory_model->get_all_active_items_list_fe($search_term, $school_id, $professor_id, $textbook_id, $class_id, $isbn, $order_by, $direction, null, null, $order_by_year);
        ...
        $items = $this->inventory_model->get_all_active_items_list_fe($search_term, $school_id, $professor_id, $textbook_id, $class_id, $isbn, $order_by, $direction, $offset, $limit, $order_by_year);
