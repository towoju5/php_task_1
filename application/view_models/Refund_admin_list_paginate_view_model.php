...
/**
 * Refund List Paginate View Model
 *
 ...
 * @author Ryan Wong
 */
class Refund_admin_list_paginate_view_model
{
    protected $_library;
    protected $_base_url = '';
    protected $_heading = 'Refund';
    protected $_total_rows = 0;
    protected $_format_layout = '';
    protected $_per_page = 10;
    protected $_page;
    protected $_num_links = 5;
    protected $_column = ['Action','ID','Order ID','User ID','Amount','Reason','Explanation','Receipt URL','Stripe Charge ID','Stripe Invoice ID','Status'];
    protected $_field_column = ['','id','order_id','user_id','amount','reason','explanation','receipt_url','stripe_charge_id','stripe_invoice_id','status'];
    protected $_list = [];
    protected $_links = '';
	...
	public $_stripe_invoice_id = NULL;
	...
	public function to_json ()
	{
		...
		foreach ($list as $key => $value)
		{
			...
			$clean_list_entry['reason'] = $list[$key]->reason;
			$clean_list_entry['explanation'] = $list[$key]->explanation;
			$clean_list_entry['receipt_url'] = $list[$key]->receipt_url;
			$clean_list_entry['stripe_charge_id'] = $list[$key]->stripe_charge_id;
			$clean_list_entry['stripe_invoice_id'] = $list[$key]->stripe_invoice_id;
