...
/**
 * Inventory_gallery_image_list List Paginate View Model
 *
 ...
 * @author Ryan Wong
 */
class Inventory_gallery_image_list_admin_list_paginate_view_model
{
    protected $_library;
    protected $_base_url = '';
    protected $_heading = 'Inventory_gallery_image_list';
    protected $_total_rows = 0;
    protected $_format_layout = '';
    protected $_per_page = 10;
    protected $_page;
    protected $_num_links = 5;
    protected $_column = ['Action','ID','Inventory ID','Gallery Image','Image ID','Status'];
    protected $_field_column = ['','id','inventory_id','gallery_image','gallery_image_id','status'];
    protected $_list = [];
    protected $_links = '';
	...
	public function to_json ()
	{
		...
		foreach ($list as $key => $value)
		{
			...
			$clean_list_entry['gallery_image'] = $list[$key]->gallery_image;
			$clean_list_entry['gallery_image_id'] = $list[$key]->gallery_image_id;
