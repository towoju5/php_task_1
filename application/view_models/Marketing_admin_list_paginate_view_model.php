...
/**
 * Marketing List Paginate View Model
 *
 ...
 * @author Ryan Wong
 */
class Marketing_admin_list_paginate_view_model
{
    protected $_library;
    protected $_base_url = '';
    protected $_heading = 'Marketing';
    protected $_total_rows = 0;
    protected $_format_layout = '';
    protected $_per_page = 10;
    protected $_page;
    protected $_num_links = 5;
    protected $_column = ['Action','Title','Url','Published Date','User Id','Status'];
    protected $_field_column = ['','title','slug','publish_date','user_id','status'];
    protected $_list = [];
    protected $_links = '';
	...
	public function to_json ()
	{
		...
		foreach ($list as $key => $value)
		{
			...
			$clean_list_entry['seo_title'] = $list[$key]->seo_title;
			$clean_list_entry['seo_description'] = $list[$key]->seo_description;
			$clean_list_entry['slug'] = $list[$key]->slug;
			$clean_list_entry['publish_date'] = $list[$key]->publish_date;
