...
/**
 * Setting List Paginate View Model
 *
 ...
 * @author Ryan Wong
 */
class Setting_admin_list_paginate_view_model
{
    protected $_library;
    protected $_base_url = '';
    protected $_heading = 'Setting';
    protected $_total_rows = 0;
    protected $_format_layout = '';
    protected $_per_page = 10;
    protected $_page;
    protected $_num_links = 5;
    protected $_column = ['Action','id','key','value'];
    protected $_field_column = ['','id','key','value'];
    protected $_list = [];
    protected $_links = '';
	...
	{
		return $this->_entity->maintenance_mapping();
	...
	public function to_json ()
	{
		...
		foreach ($list as $key => $value)
		{
			...
			$list[$key]->maintenance = $this->maintenance_mapping()[$value->maintenance];
			$clean_list_entry = [];
