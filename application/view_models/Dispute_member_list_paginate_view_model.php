...
/**
 * Dispute List Paginate View Model
 *
 ...
 * @author Ryan Wong
 */
class Dispute_member_list_paginate_view_model
{
    protected $_library;
    protected $_base_url = '';
    protected $_heading = 'Dispute';
    protected $_total_rows = 0;
    protected $_format_layout = '';
    protected $_per_page = 10;
    protected $_page;
    protected $_num_links = 5;
    protected $_column = ['Action','ID','Order ID','User ID','Reason','Explanation','Stripe Charge ID','Stripe Dispute ID','Status'];
    protected $_field_column = ['','id','order_id','user_id','reason','explanation','stripe_charge_id','stripe_dispute_id','status'];
    protected $_list = [];
    protected $_links = '';
	...
	public $_stripe_dispute_id = NULL;
	...
	public function to_json ()
	{
		...
		foreach ($list as $key => $value)
		{
			...
			$clean_list_entry['stripe_dispute_id'] = $list[$key]->stripe_dispute_id;
