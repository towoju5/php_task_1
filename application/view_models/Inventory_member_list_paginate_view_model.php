 ...
 * @author Ryan Wong
 */
class Inventory_member_list_paginate_view_model
{
    protected $_library;
    protected $_base_url = '';
    ...
    protected $_column = ['Action','ID','School','Professor','Course','Textbook','Word Count','Year','Purchased Count','Refunded Count','Status'];
    protected $_field_column = ['','id','school_id','professor_id','class_id','textbook_id','word_count','year','','','status'];
    protected $_list = [];
    protected $_links = '';
