...
/**
 * Order List Paginate View Model
 *
 ...
 * @author Ryan Wong
 */
class Order_admin_list_paginate_view_model
{
    protected $_library;
    protected $_base_url = '';
    protected $_heading = 'Order';
    protected $_total_rows = 0;
    protected $_format_layout = '';
    protected $_per_page = 10;
    protected $_page;
    protected $_num_links = 5;
    protected $_column = ['ID','User','School','Textbook','Professor','Order Date','Amount','Status','Action',];
    protected $_field_column = ['id','purchase_user_id','','','','order_date','total','status',''];
    protected $_list = [];
    protected $_links = '';
