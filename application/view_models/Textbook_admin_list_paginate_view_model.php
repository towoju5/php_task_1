...
/**
 * Textbook List Paginate View Model
 *
 ...
 * @author Ryan Wong
 */
class Textbook_admin_list_paginate_view_model
{
    protected $_library;
    protected $_base_url = '';
    protected $_heading = 'Textbook';
    protected $_total_rows = 0;
    protected $_format_layout = '';
    protected $_per_page = 10;
    protected $_page;
    protected $_num_links = 5;
    protected $_column = ['Action','ID','Name','ISBN','Status'];
    protected $_field_column = ['','id','name','isbn','status'];
    protected $_list = [];
    protected $_links = '';
