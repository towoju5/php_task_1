...
/**
 * Spreadsheet List Paginate View Model
 *
 ...
 * @author Ryan Wong
 */
class Spreadsheet_admin_list_paginate_view_model
{
    protected $_library;
    protected $_base_url = '';
    protected $_heading = 'Spreadsheet';
    protected $_total_rows = 0;
    protected $_format_layout = '';
    protected $_per_page = 10;
    protected $_page;
    protected $_num_links = 5;
    protected $_column = ['Action','ID','Name','User Id','Status','Created Date'];
    protected $_field_column = ['','id','name','user_id','status','created_at'];
    protected $_list = [];
    protected $_links = '';
