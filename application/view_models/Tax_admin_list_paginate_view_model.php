 ...
 * @author Ryan Wong
 */
class Tax_admin_list_paginate_view_model
{
    protected $_library;
    protected $_base_url = '';
    protected $_heading = 'Tax';
    protected $_total_rows = 0;
    protected $_format_layout = '';
    protected $_per_page = 10;
    protected $_page;
    protected $_num_links = 5;
    protected $_column = ['Action','ID','Tax'];
    protected $_field_column = ['','id','tax'];
    protected $_list = [];
    protected $_links = '';
