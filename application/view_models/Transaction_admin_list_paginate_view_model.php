 ...
 * @author Ryan Wong
 */
class Transaction_admin_list_paginate_view_model
{
    protected $_library;
    protected $_base_url = '';
    ...
    protected $_column = ['Action','ID','Payment Method','Order ID','Transaction Date','Transaction Time','User ID','Tax','Discount','Subtotal','Total','Status'];
    protected $_field_column = ['','id','payment_method','order_id','transaction_date','transaction_time','user_id','tax','discount','subtotal','total','status'];
    protected $_list = [];
    protected $_links = '';
