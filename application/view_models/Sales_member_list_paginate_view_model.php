...
/**
 * Sales List Paginate View Model
 *
 ...
 * @author Ryan Wong
 */
class Sales_member_list_paginate_view_model
{
    protected $_library;
    protected $_base_url = '';
    protected $_heading = 'Sales';
    protected $_total_rows = 0;
    protected $_format_layout = '';
    protected $_per_page = 10;
    protected $_page;
    protected $_num_links = 5;
    protected $_column = ['ID','Order Id','Notes Id','School','Professor','Course','Textbook','Amount','Purchase Date','Status'];
    protected $_field_column = ['id','order_id','inventory_id','','','','','amount','created_at','status'];
    protected $_list = [];
    protected $_links = '';
