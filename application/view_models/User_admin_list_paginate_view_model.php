 ...
 * @author Ryan Wong
 */
class User_admin_list_paginate_view_model
{
    protected $_library;
    protected $_base_url = '';
    protected $_heading = 'User';
    protected $_total_rows = 0;
    protected $_format_layout = '';
    protected $_per_page = 10;
    protected $_page;
    protected $_num_links = 5;
    protected $_column = ['Action','ID','Photo','Personal Information','Status'];
    protected $_field_column = ['','id','image','','status'];
    protected $_list = [];
    protected $_links = '';
	...
	public function to_json ()
	{
		...
		{
			$list[$key]->verify = $this->verify_mapping()[$value->verify];
			$list[$key]->status = $this->status_mapping()[$value->status];
			$list[$key]->role_id = $this->role_id_mapping()[$value->role_id];
