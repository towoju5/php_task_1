...
/**
 * Attribute_type List Paginate View Model
 *
 ...
 * @author Ryan Wong
 */
class Attribute_type_admin_list_paginate_view_model
{
    protected $_library;
    protected $_base_url = '';
    protected $_heading = 'Attribute_type';
    protected $_total_rows = 0;
    protected $_format_layout = '';
    protected $_per_page = 10;
    protected $_page;
    protected $_num_links = 5;
    protected $_column = ['Action','ID','Type','Field','Options'];
    protected $_field_column = ['','id','type','field','options'];
    protected $_list = [];
    protected $_links = '';
	...
	public function to_json ()
	{
		...
		foreach ($list as $key => $value)
		{
			...
			$clean_list_entry['field'] = $list[$key]->field;
			$clean_list_entry['options'] = $list[$key]->options;
