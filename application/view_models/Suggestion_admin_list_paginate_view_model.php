...
/**
 * Suggestion List Paginate View Model
 *
 ...
 * @author Ryan Wong
 */
class Suggestion_admin_list_paginate_view_model
{
    protected $_library;
    protected $_base_url = '';
    protected $_heading = 'Suggestion';
    protected $_total_rows = 0;
    protected $_format_layout = '';
    protected $_per_page = 10;
    protected $_page;
    protected $_num_links = 5;
    protected $_column = ['Action','ID','Name','Email','Suggestion Type','Message','Created At'];
    protected $_field_column = ['','id','name','email','suggestion_type','additional_notes','created_at'];
    protected $_list = [];
    protected $_links = '';
	...
	{
		return $this->_suggestion_type;
	}

	public function set_suggestion_type ($suggestion_type)
	{
		$this->_suggestion_type = $suggestion_type;
	}

	public $_suggestion_type = NULL;
	...
	{
		$this->_additional_notes = $additional_notes;
	}

	public $_additional_notes = NULL;
	...
	public function to_json ()
	{
		...
		{
			$list[$key]->suggestion_type = $this->suggestion_type_mapping()[$value->suggestion_type];
