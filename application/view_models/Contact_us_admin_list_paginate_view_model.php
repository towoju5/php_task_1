...
/**
 * Contact_us List Paginate View Model
 *
 ...
 * @author Ryan Wong
 */
class Contact_us_admin_list_paginate_view_model
{
    protected $_library;
    protected $_base_url = '';
    protected $_heading = 'Contact_us';
    protected $_total_rows = 0;
    protected $_format_layout = '';
    protected $_per_page = 10;
    protected $_page;
    protected $_num_links = 5;
    protected $_column = ['ID','Name','Email','Reason','Created At'];
    protected $_field_column = ['id','name','email','message','created_at'];
    protected $_list = [];
    protected $_links = '';
