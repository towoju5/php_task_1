 ...
 * @author Ryan Wong
 */
class Ticket_admin_list_paginate_view_model
{
    protected $_library;
    protected $_base_url = '';
    ...
    protected $_column = ['Order ID','User','Reason','Status','Action',];
    protected $_field_column = ['order_id','user_id','message','status',''];
    protected $_list = [];
    protected $_links = '';
