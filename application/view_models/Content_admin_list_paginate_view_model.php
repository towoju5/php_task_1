...
/**
 * Content List Paginate View Model
 *
 ...
 * @author Ryan Wong
 */
class Content_admin_list_paginate_view_model
{
    protected $_library;
    protected $_base_url = '';
    protected $_heading = 'Content';
    protected $_total_rows = 0;
    protected $_format_layout = '';
    protected $_per_page = 10;
    protected $_page;
    protected $_num_links = 5;
    protected $_column = ['Action','ID','Content Name','Content Type','Content','Status'];
    protected $_field_column = ['','id','content_name','content_type','content','status'];
    protected $_list = [];
    protected $_links = '';
	...
	public function to_json ()
	{
		...
		{
			$list[$key]->content_type = $this->content_type_mapping()[$value->content_type];
