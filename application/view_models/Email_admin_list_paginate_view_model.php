...
/**
 * Email List Paginate View Model
 *
 ...
 * @author Ryan Wong
 */
class Email_admin_list_paginate_view_model
{
    protected $_library;
    protected $_base_url = '';
    protected $_heading = 'Email';
    protected $_total_rows = 0;
    protected $_format_layout = '';
    protected $_per_page = 10;
    protected $_page;
    protected $_num_links = 5;
    protected $_column = ['Action','Slug','Subject','Tags'];
    protected $_field_column = ['','slug','subject','tag'];
    protected $_list = [];
    protected $_links = '';
	...
	public function to_json ()
	{
		...
		foreach ($list as $key => $value)
		{
			...
			$clean_list_entry['subject'] = $list[$key]->subject;
