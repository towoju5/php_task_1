...
/**
 * Inventory_attribute List Paginate View Model
 *
 ...
 * @author Ryan Wong
 */
class Inventory_attribute_admin_list_paginate_view_model
{
    protected $_library;
    protected $_base_url = '';
    protected $_heading = 'Inventory_attribute';
    protected $_total_rows = 0;
    protected $_format_layout = '';
    protected $_per_page = 10;
    protected $_page;
    protected $_num_links = 5;
    protected $_column = ['Action','ID','Inventory ID','Attribute ID','Value'];
    protected $_field_column = ['','id','inventory_id','attribute_id','value'];
    protected $_list = [];
    protected $_links = '';
	...
	public function to_json ()
	{
		...
		foreach ($list as $key => $value)
		{
			...
			$clean_list_entry['attribute_id'] = $list[$key]->attribute_id;
			$clean_list_entry['value'] = $list[$key]->value;
